...
class TestCard(unittest.TestCase):
    ...
    def test_q1(self):
        ...
        test_card = hw5_cards.Card(0, rank=12)
        X = test_card.rank_name
        Y = "Queen"
    ...
    def test_q2(self):
        ...
        '''
        test_card = hw5_cards.Card(suit=1, rank=12)
        X = test_card.suit_name
        Y = "Clubs"
        self.assertEqual(X, Y)
        return X, Y
